...
class Hello(object):
    ...
    # put it back
    ctx.translate(-(400+rp_g1+2*rp_g2+2*rp_g3+rp_g4),-400)
    #spur.Spur(ctx).Gear(400+rp_g1+2*rp_g2+2*rp_g3+rp_g4,rp_g4,n_g4, pa, "green")
    ctx.restore()
    ...
    # put it back
    ctx.translate(-(400+rp_g1+2*rp_g2+2*rp_g3+2*rp_g4+rp_g5),-400)
    #spur.Spur(ctx).Gear(400+rp_g1+2*rp_g2+2*rp_g3+2*rp_g4+rp_g5,rp_g5,n_g5, pa, "red")
    ctx.restore()
    ...
    # put it back
    ctx.translate(-(400+rp_g1+2*rp_g2+2*rp_g3+2*rp_g4+2*rp_g5+rp_g6),-400)
    #spur.Spur(ctx).Gear(400+rp_g1+2*rp_g2+2*rp_g3+2*rp_g4+2*rp_g5+rp_g6,rp_g6,n_g6, pa, "black")
    ctx.restore()
